...
public class MainViewController implements Initializable, ShoppingCartListener {
    ...
    @FXML private FlowPane storVarukorg;
    ...
    @FXML
    public void varukorgToFront(){
        varukorgAnchor.toFront();
    }
    @FXML
    public void returnCheckoutView1(){
        fullView.toFront();
    }
    @FXML
    public void betalningToFront(){
        betalningAnchor.toFront();
    }
    @FXML
    public void openKortbetalning(){
        kortBetalningAnchor.toFront();
    }
    @FXML
    public void openSwishbetalning(){
        swishBetalningAnchor.toFront();
    }
    @FXML
    public void openKlarnabetalning(){
        klarnaBetalningAnchor.toFront();
    }

    @FXML
    public void leveransToFront(){
        leveransAnchor.toFront();
    }
    @FXML
    public void returnCheckoutView5(){
