...
public class ProductCardSmall extends VarukorgItemController {
    @FXML private ImageView Image;
    @FXML private Label Name;
    @FXML private Label Price;
    @FXML private Button BuyButton;
    public ProductCardSmall(ShoppingItem shoppingItem, MainViewController parentController){
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("product_card_small.fxml"));
